        ...
        Try
            ...
            While MyRst.Read
                If MyRst.Item("pop_region").ToString.Trim <> "" Then
                    ...
                    If SelectedItem = -1 And NewItem.Value.ToUpper = "GAU" Then
        ...
        Try
            ...
            While MyRst.Read
                ...
                If MyRst.Item("pop_name").ToString.Trim <> "" Then
                    ...
                    tc.Items.Add(NewItem)
                End If
                OtherTowers += "var point = new GLatLng(" & MyRst.Item("pop_lat_dec").ToString & "," & MyRst.Item("pop_long_dec").ToString & ");"
                ...
                Dim Html As String = MyRst.Item("pop_name").ToString & "<br>Type: " & MyRst.Item("pop_type").ToString
                Dim Letter As String = Left(MyRst.Item("pop_type").ToString.ToUpper, 1)
                OtherTowers += "mcount++;"
                OtherTowers += "var marker = createMarkerN(point," & tc.Items.Count + 3 & ",'" & Html & "',false,'" & Letter & "');"
