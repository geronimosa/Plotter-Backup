...
Partial Class bbm
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        MyCanvas.Style.Item("width") = "310px"
        MyCanvas.Style.Item("height") = "250px"
        ...
        TheScript += vbCrLf & "         options.width=310;"
        TheScript += vbCrLf & "         options.height=150;"
        ...
        TheScript += vbCrLf & "     document.getElementById(thisdiv).style.border = 'solid 2px '+linecolors[chartnumber-1];"
            ...
            For I = 0 To UBound(MyArray, 2)
                If I < 11 Then
                    If MyArray(2, I) <> "" Then
                        ...
                        MyDiv.Style.Item("width") = "320px"
                        MyDiv.Style.Item("height") = "150px"
                        MyDiv.Style.Item("margin") = "10px"
                        MyDiv.InnerText = CounterI & ") " & MyArray(2, I) & ". "
