<%@ Page Language="VB" MasterPageFile="~/Default.master" AutoEventWireup="false" CodeFile="Maps.aspx.vb" Inherits="Maps" %>
...
<script type="text/javascript" src=gScript.js></script>
  <div   >
      <table class="ContentBG-Black" align=center ><tr>
    <td valign=top >
        ...
        <tr>
            ...
            <td align="left" colspan="3" style="height: 21px" nowrap="noWrap">
                <asp:dropdownlist ID="RegionList" runat="server" 
                    LoadingMessage="" MarkFirstMatch="True" NoWrap="True"  
                    Sort="Ascending" AutoPostBack="True">
                </asp:dropdownlist>
                &nbsp; &nbsp;<asp:dropdownlist ID="TowerList" runat="server" 
                    DropDownWidth="250px" ExpandEffect="Pixelate" LoadingMessage="" 
                    MarkFirstMatch="True" NoWrap="True"  
                    Sort="Ascending" AutoPostBack="True">
                </asp:dropdownlist>
            </td>
        </tr>
    <tr>
        ...
        <input type=button onclick='showmarkers();' value='show all towers' id="Button3" /></td>
    ...
    <tr><td colspan="2" style="height: 3px">
        LAT:
