...
//        if (typeof from != "undefined"){}
...

    {
	    ...
	    explained+="The distance is "+Math.round(kilometers*100)/100+" km's<br>";

	    if (relayactive){	        

            explained+="Tower to the relay = "+Math.round((dst_towertorelay/1000)*100)/100+" km's<br>";

            explained+="&nbsp;&nbsp;Bearing :"+bearing(p1,p3)+"° from the tower to the relay<br>" 

            explained+="Relay to the client = "+Math.round((dst_relaytoclient/1000)*100)/100+" km's<br>";

            explained+="&nbsp;&nbsp;Bearing :"+bearing(p3,p2)+"° from the relay to the client<br>" 

        }else{

            explained+="&nbsp;&nbsp;Bearing :"+bearing(p2,p1)+"° from the tower to the client<br>"         
	    ...
	    displayHL += "<li><a href='" + PlotTen1 + "' target='Near10_Client'>View Nearest 10 >> Client - Google</a></li>";
