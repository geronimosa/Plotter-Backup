<%@ Page Language="VB" AutoEventWireup="false" CodeFile="plotit.aspx.vb" Inherits="plotit" %>
...
function plotElevation(results, status) {
 ...
 // determine Min Value
    ...
    //  draw graph
    var g = new Bluff.Line('plotting', '320x150');
    g.title = "<--"+towernames;
    g.tooltips = true;
    g.dot_radius=1;
...
<center><canvas id="plotting" width="320" height="150"></canvas></center>
</div>
  </form>
